...
const ForgotForm = ({ handleForgotPassword }) => {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    try {
      setPassword(prev => ({ ...prev, loading: true, error: '', success: '' }));
        ...
        <div className="w-full max-w-md">
          <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-700 p-8 shadow-2xl">
            ...
            <div className="text-center mb-2">
              ...
              <p className="text-gray-400">Input your new password</p>
            </div>
            ...
            <form className="space-y-2" onSubmit={onSubmit}>
              ...
              {password.error && <div className="text-red-400 text-sm mb-2 flex items-center"><CircleX size={18} className='mr-1'/>{password.error}</div>}
              {password.success && (
            ...
            <div className="mt-2 text-center">
              <p className="text-sm text-gray-400">
                ...
                <a onClick={() => navigate('/auth')} className="text-blue-400 hover:text-blue-300 font-medium transition-colors cursor-pointer">
                  Sign in here
                </a>
              </p>
            </div>
