        ...
        <div className="w-full max-w-md modal-animation">
          <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl border border-gray-700 p-8 shadow-2xl">
            ...
            <div className="text-center mb-2">
              ...
              <p className="text-gray-400">Sign up to get started with Projexlify</p>
            </div>
            ...
            <div className="mt-2 text-center">
              <p className="text-sm text-gray-400">
                ...
                <a onClick={() => setCurrentAuth('login')} className="text-blue-400 hover:text-blue-300 font-medium transition-colors cursor-pointer">
                  Sign in here
                </a>
              </p>
            </div>
